...
public class PointConverter
{
	...
	public static void setScale(double scaleLength){
		scale = scaleLength;
	...
	public static void rawRotateAxisX( MyPoint p, boolean CW, double degrees )
	{
	...
	public static void rawRotateAxisY( MyPoint p, boolean CW, double degrees )
	{
	...
	public static void rawRotateAxisZ( MyPoint p, boolean CW, double degrees )
	{
